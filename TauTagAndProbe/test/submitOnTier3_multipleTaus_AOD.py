...
folder = "MC_AOD_90X_multipleTaus_21_06_17"
...
for idx, block in enumerate(fileblocks):
    ...
    if not isMC:
        ...
        cmsRun = "cmsRun test_noTagAndProbe_multipleTaus_AOD.py maxEvents=-1 inputFiles_load="+outListName + " outputFile="+outRootName + " >& " + outLogName        
