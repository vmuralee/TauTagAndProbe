...
if not isMC: # will use 80X
    ...
    process.GlobalTag.globaltag = '92X_upgrade2017_TSG_For90XSamples_V1' #MC 25 ns miniAODv2
    # process.GlobalTag.globaltag = '76X_dataRun2_16Dec2015_v0'
    process.load('TauTagAndProbe.TauTagAndProbe.MCanalysis_noTagAndProbe_multipleTaus_AOD_cff')
    process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring(
