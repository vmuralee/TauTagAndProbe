...
config.General.requestName = 'TagAndProbe_SingleMu296174'
config.General.workArea = 'DefaultCrab3Area'

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'test_SingleMu296174.py'
...
config.Data.outputDatasetTag = 'TagAndProbe_SingleMu296174'
...
# json with 3.99/fb
config.Data.runRange = '296172-296174'
